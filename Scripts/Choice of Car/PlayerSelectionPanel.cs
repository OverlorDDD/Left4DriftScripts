...
if(device==null)
    ...
    {
        if (gamepad.leftStick.x.ReadValue() > 0.5f)
            NextCar();
    ...
    public void NextCar()
    {
        ...
        if (currentCarIndex >= availableCars.Length)
            currentCarIndex = 0;
    ...
    public void NextColor()
    {
        ...
        if (currentColorIndex >= data.colorVariants.Length)
            currentColorIndex = 0;
    ...
    public void PrevColor()
    {
        ...
        if (currentColorIndex < 0)
            currentColorIndex = data.colorVariants.Length - 1;
    ...
    public void Confirm()
{
    ...
    GameData.Instance.playerCarChoices[playerIndex].carIndex =
        currentCarIndex;

    GameData.Instance.playerCarChoices[playerIndex].colorIndex =
        currentColorIndex;
